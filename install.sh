...
print_modname() {
  ...
  ui_print "5. 4k DCI Support                           (1.2)"
  ui_print "6. Increased Maximum ISO value - 12,800     (1.2)"
  ui_print "7. Constant framerates when shooting videos (1.2)"
  ui_print "8. Improved Denoising for 30 fps videos     (1.2)"
  ui_print " "
}
